...
// in simulator we redefine to format for eXdata Developer console
...
{\
	NSString * exceptionName = [@"org.exdata." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.exdata";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIeXdataNativeItemNone = -1, 
	UIeXdataNativeItemSpinner = -2,
	UIeXdataNativeItemProgressBar = -3,
	
	UIeXdataNativeItemSlider = -4,
	UIeXdataNativeItemSwitch = -5,
	UIeXdataNativeItemMultiButton = -6,
	UIeXdataNativeItemSegmented = -7,
	
	UIeXdataNativeItemTextView = -8,
	UIeXdataNativeItemTextField = -9,
	UIeXdataNativeItemSearchBar = -10,
	
	UIeXdataNativeItemPicker = -11,
	UIeXdataNativeItemDatePicker = -12,
	
	UIeXdataNativeItemInfoLight = -13,
	UIeXdataNativeItemInfoDark = -14,
	
	UIeXdataNativeItemDisclosure = -15,
	
	UIeXdataNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all eXdata instances of
