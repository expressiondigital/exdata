 ...
 * Copyright (c) 2009-2011 by eXdata, Inc. All Rights Reserved.
...
//@interface eXdataObject : NSObject
//@end

@interface eXdataObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[eXdataObject class]])
		{
			for (NSString *key in [[(eXdataObject*)o modules] allKeys])
			{
